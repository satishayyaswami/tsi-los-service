...
public class VoterIDValidation implements REST{

	private static final String PROVIDER = "digitap";

    private static final String FUNCTION = "_func";
    private static final String DATA = "_data";
    private static final String POST_VOTERID_BASIC_VALIDATION="voterid_validation";
    ...
    public void post(HttpServletRequest req, HttpServletResponse res) {
        ...
        try {
            ...
            if(func != null){
                if(func.equalsIgnoreCase(POST_VOTERID_BASIC_VALIDATION)){
                    serviceurl = providerUrl+"kyc/v1/voter";
                    data = new JSONObject();
                    data.put("client_ref_num",(String) input.get("client_ref_num"));
                    data.put("epic_number",(String) input.get("epicno"));
