...
public class Digitap implements REST {
        ...
        try {
            ...
            if(func != null){
                if(func.equalsIgnoreCase(POST_PAN_BASIC_VALIDATION)){
                    ...
                    logtransaction(clientuserid,input,output);
                }
            }
        }catch(Exception e){
    ...
    private void logtransaction(String clientuserid, JSONObject req, JSONObject res) throws Exception{
        String sql = null;
        DBQuery query = null;

        sql = "insert into _solutions_bb_kyc (client_user_id,req,res) values (?,?::json,?::json)";
