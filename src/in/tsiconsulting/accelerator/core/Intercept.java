...
public class Intercept implements Filter {
    ...
    private static final String ADMIN_OPERATION = "adm";
    private static final String API_OPERATION = "api";


    private static final HashMap<String, String> handlers = new HashMap<String, String>();
    private static final HashMap<String, String> processors = new HashMap<String, String>();
    private static final HashMap<String, Integer> apiRegistry = new HashMap<String, Integer>();
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (handlers.containsKey(servletPath.trim())) {
            ...
            String classname = handlers.get(servletPath.trim());
